...
<?php $component->withAttributes([]); ?>
    ...
    <div x-data="multicolumn">
        <div class="lead" style="display:inline-block;">
            <a href="<?php echo e(route('state.create')); ?>" class="btn btn-warning rounded-full">
            ...
            <table id="myTable" class="whitespace-nowrap">
                ...
                <tr>
                    ...
                    <ul class="flex items-center justify-center gap-2">
                            <li >
                                <a href="<?php echo e(route('state.edit', $state->id)); ?>" x-tooltip="Edit">
...
<?php endif; ?>
<?php /**PATH C:\Users\HP\Project\inventory\resources\views/state/index.blade.php ENDPATH**/ ?>