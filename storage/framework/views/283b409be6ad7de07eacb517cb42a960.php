    ...
    <nav x-data="sidebar"
        ...
        <div class="bg-white dark:bg-[#0e1726] h-full">
            ...
            <ul class="perfect-scrollbar relative font-semibold space-y-0.5 h-[calc(100vh-80px)] overflow-y-auto overflow-x-hidden  p-4 py-0"
                ...
                <?php if(\Spatie\Permission\PermissionServiceProvider::bladeMethodWrapper('hasRole', ['Admin','Designer','Developer'])): ?>
                <li class="menu nav-item">
                ...
                <?php endif; ?>
                <?php if(\Spatie\Permission\PermissionServiceProvider::bladeMethodWrapper('hasRole', ['Admin', 'Marketing'])): ?>
                <li class="menu nav-item">
...
<?php /**PATH C:\Users\HP\Project\TeamPulse\resources\views/components/common/sidebar.blade.php ENDPATH**/ ?>