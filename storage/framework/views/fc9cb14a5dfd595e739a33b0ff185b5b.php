...
<?php $component->withAttributes([]); ?>
    ...
    <div x-data="multicolumn">
        <div class="lead" style="display:inline-block;">
            <a href="<?php echo e(route('roles.create')); ?>" class="btn btn-warning rounded-full">
                    ...
                    <td class="text-center">
                        <ul class="flex items-center gap-2" >
                            <li style="display: inline-block;vertical-align:top;">
                                <a href="<?php echo e(route('roles.edit', $role->id)); ?>" x-tooltip="Edit">
...
<?php endif; ?>
<?php /**PATH /home/sanmisha/@Projects/starterkit/resources/views/roles/index.blade.php ENDPATH**/ ?>