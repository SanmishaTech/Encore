            ...
            <div class="panel">
                ...
                <form class="space-y-5" action="<?php echo e(route('contacts.update',$contact->id)); ?>" method="POST">
                    ...
                    <div>
                        ...
                        <textarea class="form-input" id="actionMessage" name="message" placeholder="Type your message....."><?php echo e($contact->message); ?></textarea>
                    </div>
...
<?php endif; ?>
<?php /**PATH /home/sanmisha/@Projects/starterkit/resources/views/contacts/edit.blade.php ENDPATH**/ ?>