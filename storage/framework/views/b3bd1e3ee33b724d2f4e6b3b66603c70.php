...
<?php $component->withAttributes([]); ?>
    ...
    <div x-data="multicolumn">        
        <div class="lead" style="display:inline-block;">
            <a href="<?php echo e(route('country.create')); ?>" class="btn btn-warning rounded-full">
        ...
        <div class="panel mt-6 table-responsive">
            <h5 class="md:absolute md:top-[25px] md:mb-0 mb-5 font-semibold text-lg dark:text-white-light">Country
            </h5>
                    ...
                    <td class="text-center">
                        <ul class="flex items-center gap-2" >
                            <li style="display: inline-block;vertical-align:top;">
                                <a href="<?php echo e(route('country.edit', $country->id)); ?>" x-tooltip="Edit">
...
<?php endif; ?>
<?php /**PATH C:\Users\HP\Project\inventory\resources\views/country/index.blade.php ENDPATH**/ ?>