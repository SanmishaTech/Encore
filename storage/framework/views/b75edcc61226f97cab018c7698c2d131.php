...
<div>
    ...
    <div class="pt-5">        
        <form class="space-y-5" action="<?php echo e(route('states.update', ['state' => $state->id])); ?>" method="POST">
            <?php echo csrf_field(); ?>
            ...
            <div class="panel">
                ...
                <div class="grid grid-cols-2 gap-4">             
                    <div> 
                        ...
                        <select class="text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" name="country_id">
                            ...
                            <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($country->id); ?>" <?php echo e($state->country_id ? (($state->country_id == $country->id) ? 'selected' : '') : ''); ?>>
                    ...
                    <div>
                        ...
                        <?php if (isset($component)) { $__componentOriginal71c6471fa76ce19017edc287b6f4508c = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.text-input','data' => ['class' => 'form-input','name' => 'name','value' => ''.e($state->name).'','required' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'form-input','name' => 'name','value' => ''.e($state->name).'','required' => true]); ?>
...
<?php unset($__componentOriginal71c6471fa76ce19017edc287b6f4508c); ?>
<?php endif; ?>
<?php /**PATH C:\Users\HP\Project\inventory\resources\views/states/edit.blade.php ENDPATH**/ ?>