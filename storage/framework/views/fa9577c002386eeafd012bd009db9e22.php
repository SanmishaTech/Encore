    ...
    <div x-data="sorting">
     <div class="lead" style="display:inline-block;">
        ...
        <div class="panel mt-6">
            <h5 class="md:absolute md:top-[25px] md:mb-0 mb-5 font-semibold text-lg dark:text-white-light"> User
            </h5>
...
<?php endif; ?>
<?php /**PATH C:\@Projects\starterkit\resources\views/user/index.blade.php ENDPATH**/ ?>