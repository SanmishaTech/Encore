...
<?php $component->withAttributes([]); ?>
    ...
    <div x-data="multicolumn">
        <div class="lead" style="display:inline-block;">
            <a href="<?php echo e(route('city.create')); ?>" class="btn btn-warning rounded-full">
            ...
            <table id="myTable" class="whitespace-nowrap">
                ...
                <tr>
                    ...
                    <ul class="flex items-center justify-center gap-2">
                            <li >
                                <a href="<?php echo e(route('city.edit', $city->id)); ?>" x-tooltip="Edit">
            ...
            Alpine.data("multicolumn", () => ({
                ...
                init() {
                    this.datatable = new simpleDatatables.DataTable('#myTable', {
                        data: {
                            headings: ["State name", "City", "Action"],
                        },
                        searchable: true,
                        perPage: 5,
...
<?php endif; ?>
<?php /**PATH C:\Users\HP\Project\inventory\resources\views/city/index.blade.php ENDPATH**/ ?>