                ...
                <form class="space-y-5" action="<?php echo e(route('roles.update',$role->id)); ?>" method="POST">
                    ...
                    <div class="grid grid-cols-2 gap-4">                  
                        <div>
                            ...
                            <?php if (isset($component)) { $__componentOriginal71c6471fa76ce19017edc287b6f4508c = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.text-input','data' => ['id' => 'name','class' => 'form-input','name' => 'name','value' => ''.e($role->name).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'name','class' => 'form-input','name' => 'name','value' => ''.e($role->name).'']); ?>
...
<?php unset($__componentOriginal71c6471fa76ce19017edc287b6f4508c); ?>
<?php endif; ?>
<?php /**PATH /home/sanmisha/@Projects/Encore/resources/views/roles/edit.blade.php ENDPATH**/ ?>