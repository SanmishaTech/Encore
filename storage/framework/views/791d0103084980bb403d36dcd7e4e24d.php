            ...
            <div class="panel grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <div class="flex flex-1">
                            ...
                            <input id="actionEmail" type="password" placeholder=""  name="password" value="<?php echo e($user->password); ?>"
                                class="form-input ltr:rounded-l-none rtl:rounded-r-none" />
                        </div>
                    </div>
...
<?php endif; ?>
<?php /**PATH /home/sanmisha/@Projects/starterkit/resources/views/users/edit.blade.php ENDPATH**/ ?>