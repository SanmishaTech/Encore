                ...
                <form method="POST" action="<?php echo e(route('users.update', ['user'=>$user->id])); ?>">
                 ...
                 <?php echo method_field('PATCH'); ?>
                    ...
                    <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
                        ...
                        <select class="form-control form-control-user <?php $__errorArgs = ['role'];
...
unset($__errorArgs, $__bag); ?>" name="role">
                            ...
                            <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($role->id); ?>" 
                                    <?php echo e(old('role_id') ? ((old('role_id') == $role->id) ? 'selected' : '') : (($user->role_id == $role->id) ? 'selected' : '')); ?>>
...
<?php endif; ?>
<?php /**PATH C:\@Projects\starterkit\resources\views/user/edit.blade.php ENDPATH**/ ?>