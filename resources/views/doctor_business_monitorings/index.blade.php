                    ...
                    <td class="float-right">
                        <ul class="flex items-center gap-2" >
                            <li style="display: inline-block;vertical-align:top;">
                                <x-edit-button :link=" route('doctor_business_monitorings.edit', $doctor_business_monitoring->id)" />                               
                            </li>
                            <li style="display: inline-block;vertical-align:top;">
                                <x-delete-button :link=" route('doctor_business_monitorings.destroy',$doctor_business_monitoring->id)" />  
                            </li>   
                        </ul>
                    </td>
                </tr>
